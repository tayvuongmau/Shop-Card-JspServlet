...
public class LoadProductAdmin extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		// lấy ra tất cả sản phẩm để load lên trang chủ dựa theo số trang giới hạn số
		// lượng sản phẩm từ câu truy vấn
		...
		// tính số trang sẽ được tạo ra dựa trên số lượng sản phẩm và số sản phẩm muốn
		// hiển thị
